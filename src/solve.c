...
int solve(int N, struct state* start_state, struct state* goal_state){
	...
	while (!fringe_empty()){
		...
		//PROBLEM IS HERE, something to do with accessing the tile array
...
int main(int argc, char** argv){
	...
	solve(N, start_state, goal_state);
	return 0;
}
